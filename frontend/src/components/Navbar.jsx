    ...
    return (
        <>
            <motion.div
                ...
                className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-black/40 border/40 border-b border-white/10"
            >
                <div className=" max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2 cursor-pointer bg-white/5 p-2 px-4 rounded-2xl border border-zinc-600">
                        <img src={img1} alt="logo" className="w-8 h-8" />
                        <span className="font-semibold text-lg bg-linear-to-r from-purole-400 to-indigo-500 bg-clip-text text-transparent">Dora</span>
                    </div>
                            ...
                            <div className='relative'>
                                <button
                                    ...
                                    <img
                                        ...
                                        src={userData ? userData.avatar : "https://ui-avatars.com/api/?name=Pra+yadav"} alt="" className="w-9 h-9 rounded-full border border-white/20 object-cover hover:scale-105 transition" />
                                </button>
                                <AnimatePresence>
                                    {openProfile && (
                                        <motion.div
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                className="w-full px-4 py-3 text-left text-sm hover:bg-white/5 text-red-400">Logout</button>
                                        </motion.div>
                                    )}
                                </AnimatePresence>
                            </div>
